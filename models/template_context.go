...
func NewPhishingTemplateContext(ctx TemplateContext, r BaseRecipient, rid string) (PhishingTemplateContext, error) {
	...
	trackingattachmentsURL, _ := url.Parse(templateURL)
	trackingattachmentsURL.Path = path.Join(trackingattachmentsURL.Path, "/attach") //INI UNTUK PATH KE ATTACHMENT URL
	trackingattachmentsURL.RawQuery = q.Encode()
	...
	return PhishingTemplateContext{
		...
		TrackingattachmentsURL: trackingattachmentsURL.String(),
		From:          fn,
		RId:           rid,
	}, nil
}
