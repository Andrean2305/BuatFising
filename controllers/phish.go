...
func (ps *PhishingServer) AttachHandler(w http.ResponseWriter, r *http.Request) { //ADDEDFORNEWFEATURE
	...
	// Call HandleAttachmentClicked function
...
func (ps *PhishingServer) registerRoutes() {
	...
	router.HandleFunc("/attach", ps.AttachHandler) // Add the new route for /attach //ADDEDFORNEWFEATURE
