    ...
    api.campaignId.results(campaign.id)
        .success(function (c) {
            ...
            $.each(campaign.results, function (i, result) {
                ...
                if (result.attach) {
                    email_series_data['Attach Clicked']++
                }
            ...
            if (campaign) {
                ...
                resultsTable = $("#resultsTable").DataTable({
                    ...
                    columnDefs: [{
                        ...
                        // {
                        //     className: "ANDREAN",
                        //     "render": function (Attach, type, row) {
                        //         if (type == "display") {
                        //             if (Attach) {
                        //                 return "<i class='fa fa-check-circle text-center text-success'></i>"
                        //             }
                ...
                $.each(campaign.results, function (i, result) {
                    var attachflag = "NO"
                    if (result.Attach && result.status == "Email Opened") {
                        result.status = "Attach Clicked"
                        attachflag = "YES"
                    }
                    ...
                    if (result.Attach && attachflag == "YES") {
                        // email_series_data['Attach Clicked']++
                        // result.status = "Email Opened"
                        result.status = "Clicked Link"
                    }else if (attachflag == "NO"){
                        if(result.Attach){
                            email_series_data['Attach Clicked']++
                        }
